...
export interface HttpErrorEffect<Err extends Error = Error> extends HttpEffect<{
    req: HttpRequest;
    error: Err;
}, HttpEffectResponse> {
}
...
export interface HttpOutputEffect<Req extends HttpRequest = HttpRequest, Res extends HttpEffectResponse = HttpEffectResponse> extends HttpEffect<{
    req: Req;
    res: Res;
}, HttpEffectResponse> {
}
